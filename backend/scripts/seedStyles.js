...
const sampleStyles = [
  ...
  },
  {
    ...
    category: 'hairstyle',
    suitableFaceShapes: ['oval', 'square', 'oblong'],
    images: ['/styles/slickback1.jpg', '/styles/slickback2.jpg'],
    description: 'Greaser-inspired style with hair combed back. Smooth and sophisticated.',
    popularity: 78,
    tags: ['classic', 'slick', 'formal', 'retro'],
    price: 1100,
    duration: 30,
    difficulty: 'medium',
    maintenance: 'high',
  ...
  },
  {
    ...
    category: 'beard',
    suitableFaceShapes: ['oval', 'heart', 'diamond'],
    images: ['/styles/soulpatch1.jpg', '/styles/soulpatch2.jpg'],
    description: 'Small patch of hair below the lower lip. Minimalist and stylish.',
    popularity: 72,
    tags: ['minimalist', 'stylish', 'small', 'unique'],
    price: 150,
    duration: 10,
    difficulty: 'easy',
    maintenance: 'low',
  ...
  },
  {
    ...
    category: 'beard',
    suitableFaceShapes: ['oval', 'square', 'oblong'],
    images: ['/styles/chinstrap1.jpg', '/styles/chinstrap2.jpg'],
    description: 'Line of facial hair along the jawline. Defines facial structure.',
    popularity: 76,
    tags: ['structured', 'defined', 'jawline', 'modern'],
    price: 250,
    duration: 20,
    difficulty: 'medium',
    maintenance: 'high',
